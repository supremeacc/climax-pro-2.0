...
def render_timeseries_panel(ds, selected_var, lat, lon):
    ...
    """
    st.markdown('<div class="section-header">Temporal Evolution at Selected Location</div>', unsafe_allow_html=True)
    ...
    if current_lat is not None and current_lon is not None:
        ...
        if fig_ts:
            ...
            st.caption(f"Temporal trend of {selected_var} structurally resampled and smoothed for clarity.")
    else:
