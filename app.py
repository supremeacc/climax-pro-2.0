...
<div class="hero-title">
    ...
    <p class="tagline">Explore atmospheric datasets through interactive spatial and temporal visualization.</p>
</div>
""", unsafe_allow_html=True)
st.markdown("---")
...
if st.session_state.dataset is not None and selected_var is not None:
    ...
    with st.container():
        st.markdown('<div class="section-card">', unsafe_allow_html=True)
        st.markdown('<div class="section-header">Climate Animation</div>', unsafe_allow_html=True)
        st.caption("Animated global playback of the dataset over time.")
